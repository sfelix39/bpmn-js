...
export default function BpmnRenderer(
  ...
  function renderLaneLabel(parentGfx, text, element) {
    var textBox = renderLabel(parentGfx, text, {
      box: {
        height: 30,
        width: element.isHorizontal ? element.height : element.width
      },
      align: 'center-middle',
      style: {
        fill: getLabelColor(element, defaultLabelColor, defaultStrokeColor)
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:Participant': function(parentGfx, element) {
      ...
      if (expandedPool) {
        drawLine(parentGfx, [
          { x: element.isHorizontal?30:0, y: element.isHorizontal?0:30 },
          { x: element.isHorizontal?30:element.width, y: element.isHorizontal?element.height:30 }
        ], {
          stroke: getStrokeColor(element, defaultStrokeColor)
        });
