...
ReplaceMenuProvider.prototype._getParticipantMultiplicity = function(element) {
  ...
  var participantHorizontal = element.isHorizontal;
  ...
  var participantEntries = [
    ...
    {
      id: 'toggle-participant-orientation',
      className: 'bpmn-icon-parallel-mi-marker',
      title: translate('Participant Orientation'),
      active: participantHorizontal,
      action: function(event, entry) {
        var isHorizontal = !entry.active;
        var context = { element: element, isHorizontal:isHorizontal };
        self._commandStack.execute('element.rotateParticipantAndLanes', context);
      }
    }
  ];
